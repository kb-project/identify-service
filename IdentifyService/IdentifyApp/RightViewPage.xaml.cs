...
namespace IdentifyApp
{
    ...
    /// </summary>
    public sealed partial class RightViewPage : Page
    {
        MediaCapture mediaCapture;
        bool isPreviewing;

        DisplayRequest displayRequest = new DisplayRequest();
        public RightViewPage()
        {
        ...
        public async void TakePhotoAsync()
        {
            ...
            StorageFile file = await myPictures.SaveFolder.CreateFileAsync("rightview.jpg", CreationCollisionOption.ReplaceExisting);
        ...
        {
            Frame.Navigate(typeof(LeftViewPage));
        }
